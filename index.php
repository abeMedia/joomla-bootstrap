...
<body>
  <?php if($layout=='boxed' ){ ?><div class="layout-boxed"><?php } ?>
    <div id="wrap">
      <!--Navigation-->
        ...
        <div class="container">
          <div id="main" class="row show-grid">
            ...
            <div id="container" class="col-sm-<?php  echo (12-$leftcolgrid-$rightcolgrid); ?>">
              ...
              <?php $app=J Factory::getApplication(); $menu=$ app->getMenu(); if ($frontpageshow){ // show on all pages ?>
              <div id="main-box">
                <jdoc:include type="message" />
                <jdoc:include type="component" />
              </div>
              <?php } else { if ($menu->getActive() !== $menu->getDefault()) { // show on all pages but the default page ?>
              <div id="main-box">
                <jdoc:include type="component" />
              </div>
              <?php }} ?>
